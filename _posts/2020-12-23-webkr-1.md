...
---
![]({{ site.url }}{{ site.baseurl }}/assets/images/webhacking/webkr1/w-p-1.png){: .aligncenter }
...
![]({{ site.url }}{{ site.baseurl }}/assets/images/webhacking/webkr1/w-p-2.png){: .aligncenter }
